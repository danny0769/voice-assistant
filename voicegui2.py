...
import random
import playsound
import speech_recognition as sr  ##recoganizes the speech
import pyjokes ##tells some random jokes
import subprocess

import pyttsx3  ## text to speech conversion
import wikipedia
import googlesearch
import webbrowser ##search mein help krta hai:
...
##helps to import the gui assitant and ui_assitant file:

engine = pyttsx3.init()
##helps to get the text to speech conversion:
# voices=engine.getProperty('voices')
# engine.setProperty('voice',voices[1].id)
rate = engine.getProperty('rate')
engine.setProperty('rate', rate - 75)
##rate to reduce the speed of word:
...
def wish():
    ...
    if hour >= 0 and hour < 12:
        speak("Good Morning I am Peaky the voice assistant created by DANISH  Do you want anything?")

    elif hour >= 12 and hour < 18:
        speak("Good Afternoon I am Peaky the voice assistant created by DANISH Do you want anything?")

    else:
        speak("Good Evening I am Peaky the voice assistant created by DANISH Do you want anything?")
...
def sendEmail(to, content):
    ...
    server.sendmail('danishjasrotia07@gmail.com', to, content)
    server.close()
...
class MainThread(QThread):
        ...
        if __name__ == "__main__":
            while self.text != "exit":
               ...
               ##  elif "daddy" in self.text:
                ...
                elif 'search' in self.text or 'play' in self.text:
    ...
    def open_application(self,text):
        if "chrome" in text:
            ...
            appli = r"C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Microsoft Office.exe"
            os.startfile(appli)
        # elif "word" in text:
        #
        #     speak("Opening word")
        #     os.startfile('C://Program Files (x86)//Microsoft Office//Office12.lnk')
...
class Main(QMainWindow):
    ...
    def startTask(self):
        ...
        self.ui.movie=QtGui.QMovie("C:/Users/fst/OneDrive/Desktop/robot-cute.gif")
